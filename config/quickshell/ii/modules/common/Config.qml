...
Singleton {
    ...
    FileView {
        ...
        JsonAdapter {
            ...
            property string panelFamily: "shadowsrealm" // ShadowsRealm: minimal AI-sidebar + cheatsheet only. ("shadowsrealm", "ii", "waffle")
            ...
            property JsonObject ai: JsonObject {
                ...
                // ShadowsRealm: Cursor API base endpoint (OpenAI-compatible chat completions).
                // Repoint this at your Cursor backend or an OpenAI-compatible proxy/gateway.
                property string cursorEndpoint: "https://api.cursor.sh/v1/chat/completions"
